...
public class ProviderController {
    ...
    @ResponseBody
    public Object delProviderById(@RequestParam("proid") String id){
    	logger.info("delProviderById proid ===================== "+id);
    	HashMap<String, String> resultMap = new HashMap<String,String>();
    	if(!StringUtils.isNullOrEmpty(id)){
    		boolean flag = providerService.deleteProviderById(Integer.parseInt(id));
    		if(flag){
